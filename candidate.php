								...
								<div class="candidateslist__item">
									...
									<div class="support" id="123123123">
										...
										<?php if ($header->hasSupport($header->candidate->id)) { ?>
											<a id="<?php echo ($header->candidate->id); ?>" data-post="<?php echo ($header->candidate->post_id); ?>" href="<?php echo ($header->address); ?>" class="unsupport__button">
										...
										<?php } else { ?>
											<a id="<?php echo ($header->candidate->id); ?>" data-post="<?php echo ($header->candidate->post_id); ?>" href="<?php echo ($header->address); ?>" class="support__button">
