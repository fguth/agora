...
$content .= "RewriteCond %{REQUEST_FILENAME} !-d" . LF;
$content .= "RewriteCond %{REQUEST_URI} ^/(AC|AL|AP|AM|BA|CE|DF|ES|GO|MA|MT|MS|MG|PA|PB|PR|PE|PI|RJ|RN|RS|RO|RR|SC|SP|SE|TO)/[^/]+/?\$ [NC]" . LF;
$content .= "RewriteRule .+ vaga-municipio.php [L,NC]" . LF;
...
$content .= "ErrorDocument 400 /error.php?400" . LF;
$content .= "ErrorDocument 401 /error.php?401" . LF;
$content .= "ErrorDocument 403 /error.php?403" . LF;
$content .= "ErrorDocument 404 /error.php?404" . LF;
$content .= "ErrorDocument 500 /error.php?500" . LF;
$content .= "ErrorDocument 501 /error.php?501" . LF;
$content .= "ErrorDocument 502 /error.php?502" . LF;
$content .= "ErrorDocument 503 /error.php?503" . LF;
