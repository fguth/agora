...
var CONFIG = (function() {
	...
	var production = {
		...
		'CHANNEL_URL'	: 'http://development.agora.vc/hypertext-preprocessor/channel.php',
		'STATUS'		: true,
		'COOKIE'		: true,
		'XFBML'			: true,
		'AJAX_URL'		: 'http://development.agora.vc/hypertext-preprocessor/system.php',
	...
	var development = {
		...
		'APP_ACTION'	: 'apoiar',
		'APP_OBJECT'	: 'candidato',
		'CHANNEL_URL'	: 'http://localhost/agora-release/hypertext-preprocessor/channel.php',
		'STATUS'		: true,
		'COOKIE'		: true,
		'XFBML'			: true,
		'AJAX_URL'		: 'http://localhost/agora-release/hypertext-preprocessor/system.php',
		'CHECK_USER'	: '8b5b422abef67a034aac2d83f07afbcd',
		'SUPPORT'		: '256fc6e4dbf98308ceca2b9b924b25af',
		'UNSUPPORT'		: '89e3d438a10459f93076b8750c1a664f',
		'PERMISSIONS'	: ['email,user_about_me,user_birthday,user_education_history,user_hometown,user_interests,user_location,user_relationships,user_religion_politics,user_work_history,publish_actions']
